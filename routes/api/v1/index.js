...
router.get('/productbill', generalSQL.selectAll('productbills'))
router.get('/productbill/:id', generalSQL.selectByID('productbills', 'productBillNo'))
router.post('/productbill', generalSQL.insertInto('productbills'))
router.patch('/productbill/:id', generalSQL.updateTable('productbills', 'productBillNo'))
router.delete('/productbill/:id', generalSQL.deleteByID('productbills', 'productBillNo'))
